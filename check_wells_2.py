...
case_file = "results_ccs_grid_CCS_maarten_wbhp_000TEST_ORIGINAL_CHANGED"
case_file = "results_ccs_grid_CCS_maarten_wbhp_000TEST_ORIGINAL_CHANGED_6bar"
case_file = "results_ccs_grid_CCS_maarten_wbhp_000" + "TEST_ORIGINAL_CHANGED_8bar_new_comp_6"
case_file = "results_ccs_grid_CCS_maarten_wbhp_000" + "ORIGINAL_TEST"
case_file = "results_ccs_grid_CCS_maarten_wbhp_000" + "ORIGINAL_TEST" + "_HETERO_3"
# case_file = "results_ccs_grid_CCS_maarten_wbhp_000TEST_ORIGINAL_CHANGED_8bar"
# case_file = "results_ccs_grid_CCS_maarten_wbhp_000TEST_ORIGINAL_CHANGED_8bar_new_comp"
case_file = "results_ccs_grid_CCS_maarten_wbhp_000" + "ORIGINAL_TEST_2"
case_file = "results_ccs_grid_CCS_maarten_wbhp_000" + "LINEAR_4dP"
case_folder = "./results/" + case_file
output_dir = "./plot_results/" + case_file
...
#         ax = axs[i]
#         ax.plot(segments, res_p, color='blue')
#         ax.plot(segments, np.ma.masked_where(res_p <= inj_p, res_p), color='red')
#         ax.plot(segments, inj_p, marker='x', linestyle='', color='orange')

#         if i == 2 and sim_time_str:
#             ax.text(0.01, 0.99, f"Simulation time (3 yrs): {sim_time_str}",
#                     transform=ax.transAxes, fontsize=10, verticalalignment='top',
#                     bbox=dict(facecolor='white', alpha=0.7))
...
# #case_file = "results_ccs_grid_CCS_maarten_wbhp_000_check_isothermal"
# #case_file = "results_ccs_grid_CCS_maarten_wbhp_000_check_thermal"
# #case_file = "results_ccs_grid_CCS_maarten_wrate_000_check_thermal"
# #case_file = "results_ccs_grid_CCS_maarten_wrate_000_check_isothermal"
# #case_file = "results_ccs_grid_CCS_maarten_wrate_000_check_isothermal_skin3"
# #case_file = "results_ccs_grid_CCS_maarten_wbhp_000_check_isothermal_skin3"
# #case_file = "results_ccs_fault=FM1_cut=CO1_grid=G1_top=TS1_mod=OBJ_mult=1_wbhp_000_thermal_relperm_adjusted"
# #case_file = "results_ccs_fault=FM1_cut=CO1_grid=G1_top=TS1_mod=OBJ_mult=1_wbhp_000_WI_ADJUSTED"
# #case_file = "results_ccs_fault=FM3_cut=CO1_grid=G1_top=TS1_mod=OBJ_mult=1_wbhp_072_WI_ADJUSTED"
# #case_file = "results_ccs_fault=FM1_cut=CO1_grid=G1_top=TS1_mod=OBJ_mult=1_wbhp_000_WI_ADJUSTED_10bar_dP_Multi_Segment_False"
# #case_file = "results_ccs_fault=FM1_cut=CO1_grid=G1_top=TS2_mod=PIX_mult=2_wbhp_007_TESTING_SLIGHT_NON_LINEAR_RELPERMS_NO_SMALL_DEVIATION_SGC_PER_REGION"
# #case_file = "results_ccs_fault=FM1_cut=CO1_grid=G1_top=TS2_mod=PIX_mult=2_wbhp_007_TESTING_SLIGHT_NON_LINEAR_RELPERMS_SMALL_DEVIATION_SGC_PER_REGION"
# #case_file = "results_ccs_fault=FM1_cut=CO1_grid=G1_top=TS2_mod=PIX_mult=2_homogeneous_wbhp_000_HOMOGENEOUS_TESTING_SLIGHT_NON_LINEAR_RELPERMS_5_BAR_NO_SGC"
# case_file = "results_ccs_fault=FM1_cut=CO1_grid=G1_top=TS2_mod=PIX_mult=2_wbhp_007_TESTING_ORIGINAL_NON_LINEAR_RELPERMS_NO_WI_ADJUSTED_5_BAR"
